package com.hoomsun.api.template;
...
public class SmsTemplateManager {
	 ...
	 */
	public static int sendSMSGet(String CorpID, String Pwd, String Mobile,
			String Content, String send_time) throws MalformedURLException,
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static int sendSMSPost(String CorpID, String Pwd, String Mobile,
			String Content, String send_time) throws MalformedURLException,
			UnsupportedEncodingException {
		...
		LogCvt.info("开始发送短信手机号码为 ：" + Mobile);
		value = new Integer(inputLine).intValue();
		LogCvt.info(String.format("返回值：%d", value));
		return value;
	}
		...
		try {
			...
			if (result.equals("-1")) {
				...
				for (String str : strArray) {
					...
					outContent = String.format(
							"第%d条回复,手机号码：%s,回复内容：%s,回复时间：%s", i, strConArr[0],
							strConArr[1], strConArr[2]);
	...
	public static void main(String[] args) {
		String sendStr = "xuxinyuan您好!红上公司提示您于20日（100），将第01期2000元存入您尾号2566银行卡中，如已还款，请忽略此短信，祝您生活愉快！联系电话：4006027111；029-68679298.";
		try {
			int code = SmsTemplateManager.sendSMSPost("XAJS003463", "ws@3463",
					"13631238895", sendStr, "");
